...
export const contractors = {
  ...
  conversion_wizard: {
    ...
    step_1: "1. Текущая карточка будет переведена в статус \"Неактивна\".",
    step_2_part_1: "2. Будет создана",
    step_2_bold: "новая",
    step_2_part_2: "карточка контрагента, связанная с текущей (преемник).",
    step_3: "3. Контакты, счета, теги и файлы будут автоматически скопированы.",
    current_form: "Текущая форма",
    new_form: "Новая форма",
    select_new_form_placeholder: "Выберите новую организационно-правовую форму...",
    source: "Источник",
    target_form: "Целевая форма",
    placeholder_12_digits: "12 цифр",
    placeholder_10_digits: "10 цифр"
  }
};
